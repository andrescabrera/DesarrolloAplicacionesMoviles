...
public class InteresesService {
	...
	public User findPostAutor(Long idPost) {
		return postDAO.read(idPost).getUsuario();
	}
	...
	//Buscar publicaciones por id interes
	public List<Post> findPostsByInterest(Long interestId) {
		return postDAO.findByInterest(interestId);
	}
